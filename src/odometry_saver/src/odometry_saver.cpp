...
public:
  ...
  : nh("~"),
    ...
    points_sub(nh.subscribe<sensor_msgs::PointCloud2>("/interactive_slam_map", 1000, &OdometrySaverNode::points_callback, this)),
    odometry_sub(nh.subscribe<nav_msgs::Odometry>("/interactive_slam_odom", 1000, &OdometrySaverNode::odometry_callback, this)),
